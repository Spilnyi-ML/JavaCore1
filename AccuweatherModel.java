        ...
        switch (period) {
            ...
            case FIVE_DAYS:
                ...
                for (int i = 0; i < 5; i++){
                    ...
                    String tempMinFiveDay = objectMapper.readTree(weatherResponseFiveDay).get("DailyForecasts")
                            .get(i).at("/Temperature/Minimum/Value").asText();
                    String tempMaxFiveDay = objectMapper.readTree(weatherResponseFiveDay).get("DailyForecasts")
